...
partido = st.sidebar.text_input("PARTIDO", value="manta vs emelec")
fecha = st.sidebar.date_input("FECHA", value=datetime.date(2026, 5, 17))
horas_disponibles = [
...
if analizar:
    ...
    st.write(f"**Fecha:** {fecha.strftime('%d/%m/%Y')}  |  **Hora:** {hora}")
